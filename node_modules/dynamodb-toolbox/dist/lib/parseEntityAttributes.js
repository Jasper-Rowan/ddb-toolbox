...
const parseEntityAttributes = (attributes, track) => {
    ...
    const parsedAttributes = Object.keys(attributes).reduce((acc, field) => {
        ...
        if (typeof attributeDefinition === 'string') {
            if ((0, utils_1.isDynamoDbType)(attributeDefinition)) {
                // Merge and return mapping
                return Object.assign(acc, (0, parseMapping_1.default)(field, { type: attributeDefinition }, track));
            }
            else {
        ...
        if (Array.isArray(attributeDefinition)) {
            return Object.assign(acc, (0, parseCompositeKey_1.default)(field, 
        ...
        return Object.assign(acc, (0, parseMapping_1.default)(field, fieldVal, track));
    }, {});
    // Check that a partitionKey was defined (additional checks done when adding table)
    if (!track.keys.partitionKey)
        (0, utils_1.error)('Entity requires a partitionKey attribute');
