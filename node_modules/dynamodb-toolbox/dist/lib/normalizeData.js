...
// Normalize Data
exports.default = () => (schema, linked, data, filter = false) => {
    ...
    const dependsOn = (map, attr) => {
        ...
        if (schema[attr].dependsOn) {
            (Array.isArray(schema[attr].dependsOn)
                ...
                : [schema[attr].dependsOn]).forEach((dependent) => {
                ...
                if (schema[dependent]) {
                    ...
                    (0, utils_1.error)(`'${dependent}' is not a valid attribute or alias name`);
                }
            });
        ...
        return Object.assign(acc, schema[field]
            ...
            : filter
                ...
                : field === '$remove'
                    ...
                    : (0, utils_1.error)(`Field '${field}' does not have a mapping or alias`));
    }, { data: {}, aliases: {} });
    ...
    const _data = Object.keys(dataMap.data).reduce((acc, field) => {
    ...
    const composites = Object.keys(linked).reduce((acc, attr) => {
        ...
        const values = linked[attr]
            ...
            return (0, utils_1.transformAttr)(schema[f], validateType(schema[f], f, _data[f]), _data);
        })
            .filter((x) => x !== null);
